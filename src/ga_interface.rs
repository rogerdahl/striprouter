...
use std::thread;
use std::vec::Vec;
use crate::ga_core::{Organism, Population, RandomIntGenerator};
...
pub struct GeneticAlgorithm {
    ...
    TEST: Arc<Mutex<RandomIntGenerator>>,
...
impl GeneticAlgorithm {
    pub fn new(n_organisms_in_population: usize, crossover_rate: f64, mutation_rate: f64) -> Self {
        Self {
            ...
            // TEST: RandomIntGenerator::new(),
            TEST: Arc::new(Mutex::new(RandomIntGenerator::new())),
            // population: Arc::new(Mutex::new(Population::new(n_organisms_in_population, crossover_rate, mutation_rate))),
        }
    }
}
